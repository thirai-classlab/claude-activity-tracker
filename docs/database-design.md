...
> **パンくず**: [README.md](../README.md) > docs > **database-design.md**
...
- [2. データフロー](#2-データフロー)
- [3. ER 図](#3-er-図)
- [4. Prisma スキーマ](#4-prisma-スキーマ)
- [5. API エンドポイント設計](#5-api-エンドポイント設計)
- [6. テーブル詳細](#6-テーブル詳細)
- [7. ダッシュボードで実現可能なビュー](#7-ダッシュボードで実現可能なビュー)
- [8. データ量見積もり](#8-データ量見積もり)
- [9. マイグレーション計画（既存データ）](#9-マイグレーション計画既存データ)
- [10. 環境変数 (.env)](#10-環境変数-env)
